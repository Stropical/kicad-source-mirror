...
static const std::map<int, COLOR4D> s_defaultTheme =
        {
            ...
            { LAYER_SCHEMATIC_AUX_ITEMS,  CSS_COLOR( 200, 200, 200, 1 ) },
            { LAYER_SCHEMATIC_BACKGROUND, CSS_COLOR( 30,  30,  30,  1 ) },
            { LAYER_HOVERED,              CSS_COLOR( 0,   0,   255, 1 ) },
            { LAYER_BRIGHTENED,           CSS_COLOR( 255, 0,   255, 1 ) },
            { LAYER_BUS,                  CSS_COLOR( 100, 150, 255, 1 ) },
            { LAYER_BUS_JUNCTION,         CSS_COLOR( 100, 150, 255, 1 ) },
            { LAYER_DEVICE_BACKGROUND,    CSS_COLOR( 50,  50,  50,  1 ) },
            { LAYER_DEVICE,               CSS_COLOR( 255, 100, 100, 1 ) },
            { LAYER_SCHEMATIC_CURSOR,     CSS_COLOR( 255, 255, 255, 1 ) },
            ...
            { LAYER_FIELDS,               CSS_COLOR( 200, 150, 255, 1 ) },
            { LAYER_SCHEMATIC_GRID,       CSS_COLOR( 100, 100, 100, 1 ) },
            { LAYER_SCHEMATIC_GRID_AXES,  CSS_COLOR( 150, 150, 200, 1 ) },
            { LAYER_HIDDEN,               CSS_COLOR( 194, 194, 194, 1 ) },
            { LAYER_JUNCTION,             CSS_COLOR( 100, 255, 100, 1 ) },
            { LAYER_GLOBLABEL,            CSS_COLOR( 255, 150, 150, 1 ) },
            { LAYER_HIERLABEL,            CSS_COLOR( 255, 220, 150, 1 ) },
            ...
            { LAYER_NOCONNECT,            CSS_COLOR( 100, 150, 255, 1 ) },
            { LAYER_NOTES,                CSS_COLOR( 150, 200, 255, 1 ) },
            { LAYER_PRIVATE_NOTES,        CSS_COLOR( 150, 150, 255, 1 ) },
            { LAYER_NOTES_BACKGROUND,     CSS_COLOR( 0,   0,   0,   0 ) },
            { LAYER_PIN,                  CSS_COLOR( 255, 150, 150, 1 ) },
            { LAYER_PINNAM,               CSS_COLOR( 100, 255, 255, 1 ) },
            { LAYER_PINNUM,               CSS_COLOR( 255, 100, 100, 1 ) },
            { LAYER_REFERENCEPART,        CSS_COLOR( 100, 255, 255, 1 ) },
#ifdef __WXMAC__
...
#endif
            { LAYER_SHEET,                  CSS_COLOR( 255, 150, 150, 1 ) },
            { LAYER_SHEET_BACKGROUND,       CSS_COLOR( 255, 255, 255, 0 ) },
            { LAYER_SHEETFILENAME,          CSS_COLOR( 255, 220, 150, 1 ) },
            { LAYER_SHEETFIELDS,            CSS_COLOR( 200, 150, 255, 1 ) },
            { LAYER_SHEETLABEL,             CSS_COLOR( 100, 255, 255, 1 ) },
            { LAYER_SHEETNAME,              CSS_COLOR( 100, 255, 255, 1 ) },
            { LAYER_VALUEPART,              CSS_COLOR( 100, 255, 255, 1 ) },
            { LAYER_WIRE,                   CSS_COLOR( 100, 255, 100, 1 ) },
            { LAYER_SCHEMATIC_DRAWINGSHEET, CSS_COLOR( 255, 150, 150, 1 ) },
            { LAYER_SCHEMATIC_PAGE_LIMITS,  CSS_COLOR( 120, 120, 120, 1 ) },
            { LAYER_OP_VOLTAGES,            CSS_COLOR( 255, 150, 200, 1 ) },
            { LAYER_OP_CURRENTS,            CSS_COLOR( 255, 100, 100, 1 ) },
